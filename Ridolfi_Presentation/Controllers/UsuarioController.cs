...
namespace ERP_CRM_Solution.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public UsuarioController(IUsuarioAppService baseApps, ILogAppService logApps, INotificacaoAppService notiApps, IConfiguracaoAppService confApps, IDepartamentoAppService depApps)
        {
            baseApp = baseApps;
            logApp = logApps;
            notiApp = notiApps;
