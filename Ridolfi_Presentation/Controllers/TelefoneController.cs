...
namespace ERP_CRM_Solution.Controllers
{
    public class TelefoneController : Controller
    {
        ...
        TELEFONES objetoForn = new TELEFONES();
        TELEFONES objetoFornAntes = new TELEFONES();
        List<TELEFONES> listaMasterForn = new List<TELEFONES>();
        String extensao;
        ...
        public ActionResult EnviarSmsTelefone(Int32 id, String mensagem)
        {
            try
            {
                TELEFONES forn = fornApp.GetById(id);
        ...
        public ActionResult MontarTelaTelefone()
        {
            ...
            ViewBag.Listas = (List<TELEFONES>)Session["ListaTelefone"];
            ...
            // Indicadores
            ViewBag.Telefones = ((List<TELEFONES>)Session["ListaTelefone"]).Count;
        ...
        [HttpPost]
        public ActionResult FiltrarTelefone(TELEFONES item)
        {
            if ((String)Session["Ativa"] == null)
            {
                return RedirectToAction("Login", "ControleAcesso");
            ...
            try
            {
                // Executa a operação
                Int32 idAss = (Int32)Session["IdAssinante"];
                List<TELEFONES> listaObj = new List<TELEFONES>();
        ...
        public ActionResult IncluirTelefone(TelefoneViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    // Executa a operação
                    TELEFONES item = Mapper.Map<TelefoneViewModel, TELEFONES>(vm);
                    ...
                    // Sucesso
                    listaMasterForn = new List<TELEFONES>();
                    Session["ListaTelefone"] = null;
        ...
        public ActionResult EditarTelefone(Int32 id)
        {
            ...
            TELEFONES item = fornApp.GetItemById(id);
        ...
        public ActionResult ExcluirTelefone(Int32 id)
        {
            ...
            // Executar
            TELEFONES item = fornApp.GetItemById(id);
            objetoFornAntes = (TELEFONES)Session["Telefone"];
        ...
        public ActionResult VerCardsTelefone()
        {
            ...
            if (((List<TELEFONES>)Session["ListaTelefone"]).Count == 0)
            {
                listaMasterForn = fornApp.GetAllItens(idAss);
                Session["ListaTelefone"] = listaMasterForn;
            }
        ...
        public ActionResult GerarRelatorioLista(Int32? tipo)
        {
            ...
            lista = (List<TELEFONES>)Session["ListaTelefone"];

            TELEFONES filtro = (TELEFONES)Session["FiltroTelefone"];
            ...
            foreach (TELEFONES item in lista)
            {
