...
namespace ApplicationServices.Services
{
    public class BeneficiarioAppService : AppServiceBase<BENEFICIARIO>, IBeneficiarioAppService
    {
        ...
        public Int32 ExecuteFilter(Int32? tipo, Int32? sexo, Int32? estado, Int32? escolaridade, Int32? parentesco, String razao, String nome, DateTime? dataNasc, out List<BENEFICIARIO> objeto)
        {
            try
            {
                ...
                // Processa filtro
                objeto = _baseService.ExecuteFilter(tipo, sexo, estado, escolaridade, parentesco, razao, nome, dataNasc);
                if (objeto.Count == 0)
                {
                    volta = 1;
                }
